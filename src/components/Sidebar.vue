        ...
        <div class="menu-list">
            <b-collapse class="menu-content collapse out" id="menucontent" visible>
                ...
                <div v-if="selected==='home'">
                    <Dropzone/>
                    <hr>
                    <a class="centered-section"> AI Assistant </a>
                    <div class="chat-toggle" style="text-align: center; margin: 20px 0;">
                        <label style="display: inline-block; cursor: pointer;">
                            <i class="fa fa-comments circle" style="margin-right: 8px;"></i>
                            <input type="checkbox" v-model="state.showChat" style="margin-right: 8px;">
                            <span class="check-font">Flight Assistant</span>
                        </label>
                    </div>
                ...
                <div v-if="selected==='other'">
                    ...
                    <div v-if="state.processDone" class="show-hide">
                        ...
                        <label>
                            <i
                            class="fa fa-comments circle"
                            title="Show flight data chatbot">
                            </i>
                            <input type="checkbox" v-model="state.showChat">
                            <a class="check-font">  Flight Assistant </a>
                        </label>
                    </div>
